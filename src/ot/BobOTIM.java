...
@Tags({DistributedTags.CLIENT_2, ApplicationTags.IM, DistributedTags.OT})
public class BobOTIM extends BobIM {
	...
	private static void delayAndLaunch(OTTimeStampingIMComposerAndLauncher composerAndLauncher) {
		...
		//Add delay here
		composerAndLauncher.getCommunicator().setMinimumDelayToServer(7000);
