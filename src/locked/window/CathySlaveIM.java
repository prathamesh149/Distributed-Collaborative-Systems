...
@Tags({ DistributedTags.CLIENT_3, ApplicationTags.REPLICATED_WINDOW,FunctionTags.CONCURRENCY_CONTROLLED })
public class CathySlaveIM implements ExampleRWSession {
